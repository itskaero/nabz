...
export const en: LocalePack = {
  ...
  strings: {
    ...
    'section.stay': 'Hospital stay',
    'section.course': 'Course in hospital',
    'section.procedures': 'Procedures',
    'doc.prescription': 'Prescription',
    'doc.discharge': 'Discharge summary',
    ...
    'label.ward': 'Ward',
    'label.condition': 'Condition on discharge',
    'label.followUpWith': 'Follow-up with',
    'label.followUpWhere': 'Where',
